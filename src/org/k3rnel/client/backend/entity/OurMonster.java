...
public class OurMonster extends Monster {
	 ...
	 * @return
	 */
	public OurMonster initTradeMonster(String[] info) {
		...
		setType1(Monstertype.valueOf(info[11]));
		if (info[12] != null && !info[12].equalsIgnoreCase("")) {
			setType2(Monstertype.valueOf(info[12]));
		}
