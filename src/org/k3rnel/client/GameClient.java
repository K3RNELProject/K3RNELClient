...
import org.k3rnel.client.backend.Animator;
import org.k3rnel.client.backend.BattleManager;
import org.k3rnel.client.backend.ClientMap;
import org.k3rnel.client.backend.ClientMapMatrix;
import org.k3rnel.client.backend.ItemDatabase;
import org.k3rnel.client.backend.MoveLearningManager;
import org.k3rnel.client.backend.SoundManager;
import org.k3rnel.client.backend.SpriteFactory;
...
import org.k3rnel.client.backend.time.TimeService;
import org.k3rnel.client.backend.time.WeatherService;
import org.k3rnel.client.backend.time.WeatherService.Weather;
import org.k3rnel.client.network.ChatProtocolHandler;
import org.k3rnel.client.network.PacketGenerator;
import org.k3rnel.client.network.TcpProtocolHandler;
import org.k3rnel.client.network.UdpProtocolHandler;
import org.k3rnel.client.ui.LoadingScreen;
import org.k3rnel.client.ui.LoginScreen;
import org.k3rnel.client.ui.Ui;
import org.k3rnel.client.ui.base.ConfirmationDialog;
import org.k3rnel.client.ui.base.MessageDialog;
import org.k3rnel.client.ui.frames.PlayerPopupDialog;
...
//		m_loadImage = m_loadImage.getScaledCopy(gc.getWidth() / m_loadImage.getWidth());
		 ...
		 */
		//create fonts
		//m_fontLarge = new AngelCodeFont();
		//m_fontSmall = new AngelCodeFont();
...
//		LoadingList.setDeferredLoading(false);
	...
	public void update(GameContainer gc, int delta) throws SlickException {
		...
		if (LoadingList.get().getRemainingResources() > 0) {
			...
			if (!m_started) {
				m_started = true;
				//TODO: choose starting track
				m_soundPlayer.setTrack("");
//				music.loop();
//				sound.play();
				if(m_ui == null){
					LoadingList.setDeferredLoading(false);
