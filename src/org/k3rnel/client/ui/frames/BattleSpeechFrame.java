...
public class BattleSpeechFrame extends SpeechFrame {
    ...
    public boolean canAdvance() {
            if (speechQueue.peek() == null &&
                            stringToPrint != null && (stringToPrint.equals("Awaiting your move.") || stringToPrint.equals("Awaiting players' moves.") || stringToPrint.equals("Awaiting opponent's Monster switch."))) {
                    return false;
            } 
            else return true;
    }
    ...
    public void update(GUIContext ctx, int delta) {
            ...
            if (speechDisplay.getText().equals("")
                            && speechQueue.peek() != null &&
                            (speechQueue.peek().equals("Awaiting your move.") || speechQueue.peek().equals("Awaiting players' moves.") || speechQueue.peek().equals("Awaiting opponent's Monster switch.")))
                    advance();
    }
