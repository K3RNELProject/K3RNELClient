...
import org.k3rnel.client.ui.base.HUDButtonFactory;
import org.k3rnel.client.ui.base.ImageButton;
import org.k3rnel.client.ui.frames.BagDialog;
import org.k3rnel.client.ui.frames.BigBagDialog;
import org.k3rnel.client.ui.frames.ChatDialog;
import org.k3rnel.client.ui.frames.FriendListDialog;
import org.k3rnel.client.ui.frames.HelpWindow;
import org.k3rnel.client.ui.frames.NPCSpeechFrame;
import org.k3rnel.client.ui.frames.OptionsDialog;
import org.k3rnel.client.ui.frames.PartyInfoDialog;
import org.k3rnel.client.ui.frames.PlayerInfoDialog;
import org.k3rnel.client.ui.frames.StorageBoxFrame;
import org.k3rnel.client.ui.frames.RequestDialog;
import org.k3rnel.client.ui.frames.ShopDialog;
import org.k3rnel.client.ui.frames.TownMap;
import org.k3rnel.client.ui.frames.TradeDialog;
...
public class Ui extends Frame {
	...
	private StorageBoxFrame m_storageBox;
    ...
    public void update(boolean money){
    	if (money){
    		...
    		try{
    			if (m_teamInfo != null)
    				m_teamInfo.update(GameClient.getInstance().getOurPlayer().getMonsters());
...
//			usePokeStorageBox("");
    ...
    public void useStorageBox(int[] data){
    	m_storageBox = new StorageBoxFrame(data);
     ...
     */
    public StorageBoxFrame getStorageBox(){
    	return m_storageBox;
    }
    ...
    public void tryEvolve(int pokeIndex) {
    	...
    	m_evolveDialog = new ConfirmationDialog(GameClient.getInstance().getOurPlayer().getMonsters()
